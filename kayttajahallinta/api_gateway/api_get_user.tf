#  LUODAAN API GATEWAYN ALLE TOTEUTUS LAMBDAN GET USER -TOIMINNOLLE

//#  Luodaan mystocks APIlle resurssi get_user
...
#  luodaan API Gatewaylle metodi GET
...
resource "aws_api_gateway_deployment" "get_user" {
